...
/////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  {                  //  [BONUS] SVMPLR - Running Up That Hill  // 
    cid: "bafybeib7ydxssp2lssounls5po4o5ypr52rdpnrv73duwtqod7v4hcfmv4",
    name: '[BONUS] SVMPLR - Running Up That Hill',
    nftId: [
      "0xe61495b628bcd46414e6145c50a89cc9833a15689a3e8e8481339f33f563f651", // No Sleep
      "0x95629a13d2bb9d89927f5d4a08a721ab1b6c4eb22ed4891b09fd4dbdd47360f3", // Remedy
      "0x6c2da065b29c6fce4dbf81184c9cad97320513502c22c80ecfcd4144c5963daf", // Groove
  ...
  {                     //      [BONUS] RIO DE JANEIRO       //
    cid: "bafybeiblm3y6siqt7jioqpu6eofm2la7hyx2bqav5fuxrmmfjiwcmz2tgi",
    name: '[BONUS] RIO DE JANEIRO',
    nftId: [
      "0xcb322d249745d385d63232d844ddb2f997642f0a3166a2119e2d45e1df865bc0", // Stockholm
      "0xca82f5764f8b798cfff469e7c227c411fc7a039c6ab65e886297b5ffcc2a6b2e", // Chicago
      "0xb54b0bd6c73ed02cd5cce5e80b84a31f04d8c3bcb291482a7cd75456c5f596e9", // Ottawa
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////
                    //              WORLD OF SVMPLR                  //
  {                //                                               //
    cid: "bafybeib7gb7paef2c2t4eluaplukidqi2opa32cvm4fofkkl6sddksy4lu",
    name: 'SVMPLR - Shanti (Code) | Cyber Rave II',
    nftId: [
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////
                   //              Sounds OF SVMPLR                  //
 {                //                                                //
    cid: "bafybeihnfxafz33nlb4yqacn4frdjpvttr57mtruptkdshpmnio3qjyqxq",
    name: 'SVMPLR - No Sleep',
    nftId: [
      "0xe61495b628bcd46414e6145c50a89cc9833a15689a3e8e8481339f33f563f651", // No Sleep
    ],
    requireAll: true,
  ...
  /////////////////////////////////////////////////////////////////////////////////////////////////
                    //              BEATS BY SVMPLR                   //
 {                 //                                                //
    cid: "bafybeiaihjj243xjo2swmmebo2au6ewqqzxvvlbsjjzzbqopvlfqi6nhgi",
    name: 'SVMPLR - Stockholm',
    nftId: [
      "0xcb322d249745d385d63232d844ddb2f997642f0a3166a2119e2d45e1df865bc0", // Stockholm
    ],
    requireAll: true,
